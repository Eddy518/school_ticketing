...
app.config["SECRET_KEY"] = "\xce\xf2i\x87\x05<\xdaB\xf2\x1e\x80\x8f"
...
SERVICE_DEPARTMENTS = {
    ...
    "finance": {"student_finance_banking": "Student Finance and Banking"},
}
    ...
    if service_key:
        ...
        for dept, services in SERVICE_DEPARTMENTS.items():
            if service_key in services.keys():
                ...
                return (dept.replace("_", " "), services[service_key])
